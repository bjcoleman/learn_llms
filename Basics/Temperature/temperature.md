...
1. Open Chat (`⌘1`) and load Gemma 4 E4B if needed.
...
Top P cuts out lower-probability word choices. Turn it off so Temperature can show more variety. Min P can stay on.
...
Your panel should look like this (Thinking off, Top K at `100`, Top P off):
